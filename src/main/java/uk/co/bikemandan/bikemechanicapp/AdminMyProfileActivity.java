...
import uk.co.bikemandan.bikemechanicapp.Fragments.AdminAddAdminFragment;
import uk.co.bikemandan.bikemechanicapp.Fragments.AdminMyProfileFragment;
...
public class AdminMyProfileActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new AdminMyProfileFragment(), "Profile");
        adapter.addFragment(new AdminAddAdminFragment(), "Add admin");
    /*
